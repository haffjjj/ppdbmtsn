...
Class M_admin extends CI_Model{
    ...
    public function get_peserta(){
        $this->db->select('tb_kartu.urutan,tb_siswa.id,tb_siswa.dari_sekolah,tb_siswa.siswa_namalengkap,tb_siswa.siswa_kelamin,tb_siswa.lbp_sklh_nisn,tb_siswa.lbp_sklh_nama,tb_siswa.status');
